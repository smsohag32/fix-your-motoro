...
const ContactSection = () => {
  return (
      <div className="md:w-2/4 p-2 mx-auto">
        ...
        <div className="grid justify-center md:gap-8 gap-2 mx-auto mt-10 md:grid-cols-3">
          <div className="mx-auto text-center">
            <FaHome className="mx-auto text-7xl text-[#f02801]" />
            <p className="text-2xl">Address:</p>
            <p className="text-center">123 Street, City</p>
          </div>

          <div className="text-center">
            <FaPhoneAlt className="mx-auto text-6xl text-[#f02801] mb-4" />
            <p className="text-2xl">Phone:</p>
            <p className="text-center">(123) 456-7890</p>
          </div>

          <div className="text-center">
            <MdOutlineMail className="mx-auto text-7xl text-[#f02801]" />
