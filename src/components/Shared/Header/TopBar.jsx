  ...
  return (
    <div className="flex justify-between gap-10 ps-4 w-full">
      ...
      <div className="primary-bg h-14 flex items-center text-right justify-end">
        <button className="block h-14 md:text-sm text-lg ps-8 md:ps-16 py-2 text-center font-semibold bg-[#f02801] text-white hover:bg-[#bb3f26e7]  md:pr-10 sm:pr-4 pr-5">
          Get Appointment
        </button>
      </div>
    </div>
