      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col">
            <label htmlFor="lat" className="mb-2 font-bold">
              Latitude *{" "}
            </label>
            <input
              type="text"
              id="lat"
              className="w-full rounded-md p-2  focus:outline-sky-500 border border-gray-600"
              placeholder="Workshop Latitude"
              required
              {...register("lat")}
            />
          </div>
          <div className="flex flex-col">
            <label htmlFor="lon" className="mb-2 font-bold">
              Longitude *
            </label>
            <input
              type="lon"
              id="lon"
              placeholder="Workshop longitude"
              typeof="text"
              className="w-full rounded-md p-2  focus:outline-sky-500 border border-gray-600"
              required
              {...register("lon")}
          ...
          <div className="flex flex-col">
            <label htmlFor="technicaian" className="mb-2 font-bold">
              Technicaian
            </label>
            <select
              className="w-full rounded-md p-2  focus:outline-sky-500 border border-gray-600"
              id="technicaian"
              {...register("technicaian")}
            >
